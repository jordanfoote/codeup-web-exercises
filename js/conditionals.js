...
function analyzeColor(input) {
    if (input === 'blue') {
        ...
        alert(input + " is a great color!");
    }
}

var favColor = prompt("What is your favorite color?");

analyzeColor(favColor.toLowerCase());
*/
...
function calculateTotal(luckyNum, total) {
    ...
    alert("Your discounted price is $" + discountPrice);
}
*/
...
var canEnterNum = confirm("Whould you like to enter a number?");
...
function add100(number) {
    alert("Your number plus 100 = " + (number + 100));
}
